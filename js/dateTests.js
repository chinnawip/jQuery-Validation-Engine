...
test("Rule : DAT00003", function() {
        ...
        var field = $('#date1');
         ...
         field.val("9.9");
         $.methodDate(field, rules, i, options);
         equal(jQuery.data(input,"resultString"),options.allrules[rules[1]].alertText + ' ' + options.allrules[rules[1]].dateFormat.replace(/,/g," or "),"Input : "+field.val()+ ", Result : "+jQuery.data(input,"resultString")); 
         field.val("12121");
         $.methodDate(field, rules, i, options);
         equal(jQuery.data(input,"resultString"),options.allrules[rules[1]].alertText + ' ' + options.allrules[rules[1]].dateFormat.replace(/,/g," or "),"Input : "+field.val()+ ", Result : "+jQuery.data(input,"resultString"));  
         field.val("12.9.");
